...
<template>
    <div class="bg-gray">
        <div class="container container-subject">
            ...
            <div class="btn-group">
                <button class="subject-btn" :class="{'active' : subject === 'debit'}" @click="subject = 'debit'">Debit</button>
                <button class="subject-btn" :class="{'active' : subject === 'credit'}" @click="subject = 'credit'">Credit</button>
            </div>
            <div class="subject_content debit" v-if="subject === 'debit'">
                <div class="add_subject">
                    <h3>新增Debit</h3>
                    <v-form id="form" ref="dform" v-slot="{ errors }" @submit="addDebitItem">
                        <div class="input_item">
                            <label>
                                ...
                                :class="{ 'is-invalid': errors['代號'] }"></v-field>
            ...
            <div class="subject_content credit" v-else>
                <div class="add_subject">
                    <h3>新增Credit</h3>
                    <v-form id="form" ref="Cform" v-slot="{ errors }" @submit="addCreditItem">
                        <div class="input_item">
                            <label>
                                代號 <br>
                                <v-field type="number" 
                                ...
                                :class="{ 'is-invalid': errors['Credit代號'] }"></v-field>
                        ...
                        <div class="input_item">
                            <label for="">
                                ...
                                <v-field type="text"
                                 ...
                                 v-model="creditItem.NAME"></v-field>
