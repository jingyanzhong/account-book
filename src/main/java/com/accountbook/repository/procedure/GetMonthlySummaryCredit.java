 ...
 * @since 2024/12/09
 */
public class GetMonthlySummaryCredit extends ProcedureDto<GetMonthlySummary> {

    public GetMonthlySummaryCredit(List<ProcedureParam> params) {
        super(params);
    }

    @Override
    public String getName() {
        return "get_monthly_summary_credit";
    }
